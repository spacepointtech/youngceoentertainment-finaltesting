...
//           You are currently on the <span style={{ color: "#121212" }}>Independent Label</span>.
//         </p>
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 gap-6">
        ...
        >
          <p className="text-lg font-medium mb-1">
            You are currently on the <span className="font-semibold">Independent Label</span>.
          </p>
          <p className="text-white/70">To unlock all premium features, you need to pay</p>
          <p className="text-2xl font-semibold mt-4">₹5599/Year</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-lg bg-[#1E1E1E] border border-[#444444]">
            ...
            <p className="text-sm text-gray-400 ">
              Access an upgraded dashboard with detailed insights into your music's performance meets, customized reports, 
              and any additional tools to manage your releases. 
